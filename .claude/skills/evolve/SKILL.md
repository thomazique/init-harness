...
1. **Escolher.** `suggestions <skill>`: uma com `status: proposed`. Sem sugestão, não há evidência para evoluir: parar. Sem proposta ainda: `propose <skill> --suggestion <S-ID> --owner <quem pediu>`.
